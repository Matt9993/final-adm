    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Albumnév: {{$title}}</h2></div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img id="{{ $mainPic }}" src="{{ URL::asset($coverPath . '/' . $mainPic) }}" width="100" height="69"></td>
                                        <td> {{ $mainPic }} </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img id="{{ $pics }}" src="{{ URL::asset($path . '/' . $pics) }}" width="100" height="69"></td>
                                        <td> {{ $pics }} </td>
                                        <td>
                            ...
                            <br>
                            <button id='saveImages'  class="btn btn-primary save" style="margin-top:10px">Mentés</button>
                        ...
                        {!! csrf_field() !!}
                            ...
                            <div class="control-group input-group" style="margin-top:10px">
                                ...
                                <div class="input-group-btn"> 
                                <button class="btn btn-danger" type="button"><i class="glyphicon glyphicon-remove"></i> Törlés</button>
                                </div>
                            </div>
                            </div>
                            <input type="hidden" value="{{$title}}" id="title" name="title" />
                            <button type="submit" class="btn btn-primary" style="margin-top:10px">Mentés</button>
                        </form>
                    </div>
                </div>
            </div>
